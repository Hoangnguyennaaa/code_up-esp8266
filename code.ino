//Chỉ là thử nghiệm nên dễ xảy ra lỗi
//nguyenhoanghaky@gmail.com
...
const char *ssid = "Tester"; //nhap ten wifi can ket noi
const char *password = "123456789";     // nhap mat khau wifi do (neu khong co thi bo trong).
String postData ; 
String link = "http://192.168.248.88/biometricattendance/getdata.php";     //sua ip theo dia chi wifi ket noi.
int FingerID = 0;     
uint8_t id;
...
uint8_t getFingerprintEnroll() {
  ...
  display.setTextColor(WHITE);        // Draw white text
  display.setCursor(0,0);             // Start at top-left corner
  display.print(F("Quet lai"));
  display.setCursor(0,20);
  display.print(F("lan 2"));
  display.display();
